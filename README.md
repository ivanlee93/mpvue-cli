...
## 纯微信小程序推荐[omi-mp-create](https://github.com/ivanlee93/omi-mp-create-cli)，腾讯出品的原生框架，有类似Vuex的体验，新手使用mpvue，不建议用在公司的紧急上线的项目上！
## [omi-mp-create](https://github.com/ivanlee93/uni-template-vuex) 也是一个不错跨平台框架
...
优点：简化了授权的代码量，点击按钮的时候自动判断授权，如果没有自动弹窗
...
saveImageToPhotosAlbum (e) {
      this.$iBox.auth(
        'saveImageToPhotosAlbum', {
          filePath: e.target.tempFilePath,
          success: (res) => {
            this.$iBox.showToast('保存成功')
...
<img width="280" height="500" src="./image/1.png"/> <img width="280" height="500" src="./image/2.png"/> <img width="280" height="500" src="./image/3.jpg"/>
